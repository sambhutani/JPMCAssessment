...
public class NGram {
    ...
    public static void main(String[] args) {
        ...
        String [] sequences = firstWordTrim(findNgram(text, word, n), n);
//        for (String current : sequences) {
//            System.out.println(current);
//        }
        Map<String, Integer> counted = sortValue(getCountOfWords(sequences));
       // System.out.println(counted);
        ...
        while (iterator.hasNext()) {
            ...
            System.out.print(pair.getKey() + "," + probability((Integer) pair.getValue(), sequences.length));
            counter++;
        }
    }
    ...
    public static String[] findNgram(String text, String word, int n) {
        String[] words = findWords(text);
...
//        }
    ...
    public static String[] firstWordTrim(String[] ngrams, int n) {
    ...
    public static Map<String, Integer> getCountOfWords(String[] words) {
        Map<String, Integer> countedWords= new TreeMap<String, Integer>();
    ...
    public static String probability(int count, int total) {
        Float result = (float)count/total;
       // System.out.println(result);
        return String.format("%.3f", result);
    }

    public static <T, E extends Comparable<? super E>> Map<T, E> sortValue(Map<T, E> map) {
        List<Map.Entry<T, E>> list = new LinkedList(map.entrySet());
        ...
        Map<T, E> result = new LinkedHashMap<T,E>();
        for (Map.Entry<T, E> entry : list) {
